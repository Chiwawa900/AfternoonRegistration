...
def add_product(request):
    if request.method == "POST":
        product_name = not request.POST.get('p_name')
        product_price = not request.POST.get('p_price')
        product_quantity = not request.POST.get('p_quantity')
...
def pay(request, id):
    ...
    if request.method == "POST":
        ...
        return JsonResponse(transaction.responce_description, safe=False)
